    ...
    <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">SteinsTech</span></h1>
        ...
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
          <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
            ...
            @foreach ($brands as $brand)
              <div class="flex flex-col justify-between bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ "brand-$brand->id" }}">
                <a href="" class="flex justify-center items-center h-[15rem]">
                  <img src="{{ route('private.file', ['path' => $brand->image]) }}" alt="{{ $brand->name }}">
                </a>
              ...
              <div class="p-4 md:p-5">
                <div class="flex justify-between items-center">
                  <div class="flex items-center">
                    <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{ route('private.file', ['path' => $category->image]) }}" alt="Image Description">
                    <div class="ms-3">
